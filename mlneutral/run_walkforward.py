...
CONFIG = {
    ...
    # Model parameters
    'horizon': 72,                  # Prediction horizon (in data periods)
    'target_col': 'target72',        # Target column name
    'target_func': 'weight',

    # Training parameters
    'max_hp_evals': 1,            # HP optimization iterations per period
    'min_train_months': 3,         # Minimum months of data to start training

    # Output
    'output_dir': 'walkforward_results_weight_lr5e-2_early50_72',
...
def run():
    ...
    wf = WalkForwardTest(
        ...
        anti_leaking_days=int(CONFIG['horizon']/24)
    )
